...
<xsl:template match="/">
    <html>
        <head >
            ...
            <title>Server2 Stats</title>
            
            <link rel="icon" type="image/png" href="http://brasero.kazeo.com/sites/fr/photos/351/statistiques-mondiales-en-temps-reel-br-des-chiffres-surprenants_3510209-M.png"/>
			
				
					<meta>
		<xsl:attribute name ="http-equiv">refresh</xsl:attribute>
		<xsl:attribute name ="content">20</xsl:attribute>
		</meta>
		
		
       
        </head>
        <body style="color:#222222" bgcolor="#dddddd">
            ...
            <hr/>
            Generated by nginx-rtmp-module &#160;<xsl:value-of select="/rtmp/nginx_rtmp_version"/>,
...
<xsl:template match="rtmp">
    <table  cellspacing="1" cellpadding="5">
        <tr bgcolor="#222222">
            <th style="color:white">RTMP</th>
            <th style="color:white">#clients</th>
            <th style="color:white" colspan="4">Video</th>
            <th style="color:white" colspan="4">Audio</th>
            <th style="color:white" >In bytes</th>
            <th style="color:white">Out bytes</th>
            <th style="color:white">In bits/s</th>
            <th style="color:white">Out bits/s</th>
            <th style="color:white">BP (1000Mb/s)</th>
            <th style="color:white">Time</th>
        </tr>
        <tr bgcolor="#FFFFFF" style="color:#222222">
            <td colspan="2"><center>Accepted: <xsl:value-of select="naccepted"/></center></td>
            <th bgcolor="#FFFFFF">codec</th>
            <th bgcolor="#FFFFFF">bits/s</th>
            <th bgcolor="#FFFFFF">size</th>
            <th bgcolor="#FFFFFF">fps</th>
            <th bgcolor="#FFFFFF">codec</th>
            <th bgcolor="#FFFFFF">bits/s</th>
            <th bgcolor="#FFFFFF">freq</th>
            <th bgcolor="#FFFFFF">chan</th>
            <td>
            ...
            <td>
				<xsl:call-template name="showsize">
                    <xsl:with-param name="size" select="bw_out + bw_in"/>
                    <xsl:with-param name="bits" select="1"/>
                    <xsl:with-param name="persec" select="1"/>
                </xsl:call-template>
			</td>            <td>
